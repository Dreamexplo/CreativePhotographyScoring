...
def plot_group_comparison(db):
    ...
    ax.set_title("Intergroup Comparison")  
    ax.set_xlabel("Group")  
...
def plot_all_students(db):
    ...
    fig, ax = plt.subplots()
    ax.bar(names, scores)
    ax.set_title("Comparison of All Members")  
...
def plot_history_trend(db):
    ...
    for student in students:
        ...
        ax.set_title("Historical Trend of Individual Performance")  
        ax.set_xlabel("Time")  
        ax.set_ylabel("Final Score")  
    ...
    for group in groups:
        ...
        ax.set_title("Historical Trend of Group Performance")  
        ax.set_xlabel("Time")  
        ax.set_ylabel("Average Score")  
...
def plot_cumulative_scores(db):
    ...
    fig, ax = plt.subplots()
    ax.bar(names, scores)
    ax.set_title("Cumulative Scores of All Members")  
